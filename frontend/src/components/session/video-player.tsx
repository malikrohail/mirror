      ...
      <CardHeader className="flex flex-row items-center justify-between pb-3">
        ...
        {video?.status === 'complete' && (
          <div className="flex items-center gap-2">
            ...
            <a href={getVideoDownloadUrl(sessionId)} download>
      ...
      <CardContent>
        {!video || video.status === 'failed' ? (
          <div className="flex flex-col items-center justify-center gap-4 py-12">
            ...
            <p className="text-sm text-muted-foreground">
              Generate a video replay of this session
            </p>
            <div className="flex items-center gap-3">
              ...
              <Button
                onClick={() =>
                  gen.mutate({
                    sessionId,
                    options: { include_narration: narration },
                  })
                }
          ...
          <div className="space-y-3">
            <div className="overflow-hidden rounded-lg border bg-black">
              <img
                src={getVideoDownloadUrl(sessionId)}
                alt="Session replay"
            ...
            <div className="flex items-center justify-between">
              <p className="text-xs text-muted-foreground">
                {video.has_narration ? 'With narration' : 'Without narration'}
              </p>
              <Button
                variant="ghost"
                size="sm"
                onClick={() => gen.mutate({ sessionId })}
                disabled={gen.isPending}
              >
